...
<head>
  ...
  <title>Effervescence 2018 Merchandise orders</title>
      ...
      <div class="container-fluid">
        <div class="row hero-header" id="home">
          ...
          <a href="https://effe.org.in"><img src="../images/logo.png" id="effe-logo" class="logo img-circle img responsive"></a>
            <h1>Effervescence'18 | Merchandise Orders</h1>
      ...
      <div class="container">
        ...
        <div class="row me-row content-ct">
          <div class="col-md-6" style="margin-top:1em;">
            <img src="../images/cash-pay.jpg" class="img-responsive" style="height:200px; width:400px;" id="">
            <h3> Pay in Cash</h3>
          </div>
          <div class="col-md-6" style="margin-top:1em;">
            <img src="../images/paytm.jpg" class="img-responsive" style="height:200px; width:400px;" id="">
            <h3> Pay via Paytm / GPay</h3>
          </div>
        </div>
        ...
        <div class="col-md-12 contact-form">
            ...
            <form class="form-horizontal" data-toggle="validator" action="submit.php" role="form" method="post" name="f">
              ...
              <div class="form-group">
                <label for="uroll" class="col-sm-2 control-label">Enrollment No</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control" id="uroll" name="uroll" placeholder="Your Enrollment No" value="">
                  <div class="help-block with-errors pull-right"></div>
                  <span class="form-control-feedback" aria-hidden="true"></span>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <select class="form-control" id="ttype" name="ttype">
                    <option value="Green-Blue">Type A</option>
                    <option value="Cream">Type B </option>
                    <option value="Maroon">Type C</option>
                    <!-- <option value="Light Blue">Type D</option> -->
                  </select>
                </div>
              </div>
              <div class="form-group">
              ...
              <!-- <div class="text-center" style="margin-top=2em;">
                <h6> Make sure you have paid amount specified in amount field in case you opted for payments via PayTm or Tez. </h6>
              </div>   -->
              <div class="form-group">
          ...
          <div class="col-md-12 text-left" style="margin-top:1em;">
              ...
              <ul>
                <li style="list-style-type: disc;"> In case you choose to pay via Tez or PayTm. Make payment to QR code given via <b>TEZ</b> or <b>Paytm</b> UPI services only. </li>
                ...
                <li style="list-style-type: disc;"> Once your payment via TEz or PayTm is confirmed note your transaction number and keep it with you. </li>
                <li style="list-style-type: disc;"> If you choose to pay via cash. A volunteer will come to you to collect the amount. </li>                
                <li style="list-style-type: disc;"> Fill merchandise form and mention your <b>transaction ID (For Tez and PayTm only)</b> and and <b>Payment method</b>. </li>
                <li style="list-style-type: disc;"> Submit the form and you are done.</li>
                <li style="list-style-type: disc;"> Once your payment is confirmed you can view the same on check you status page. (For payments via tez and paytm only) </li>
